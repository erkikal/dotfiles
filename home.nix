...

{
  ...
  xdg = {
    configFile = {
      ...
      "nvim".source = config.lib.file.mkOutOfStoreSymlink "./neovim/erki-kickstart";
      "nix".source = "./nix";
      "nix-darwin".source = "./nix-darwin";
      "home-manager/home.nix".source = "./nix-darwin/home.nix";
      "kanata".source = "./kanata";
      "k9s/skins".source = "./k9s/skins";
      "raycast".source = config.lib.file.mkOutOfStoreSymlink "./raycast";
      "sketchybar".source = "./sketchybar";
    };
  };

  imports = [
    # /Users/erkik/github/dotfiles/nix-darwin/modules/git/git.nix
    ./nix-darwin/modules/git/git.nix
  ];
    ...
    claude-code = {
      ...
      settings = {
        env = {
          ...
          ANTHROPIC_AUTH_TOKEN = builtins.readFile config.sops.secrets.claude_token.path;
  ...
  sops = {
    age.keyFile = "/home/erkik/.config/sops/age/keys.txt";
    defaultSopsFile = "./nix-darwin/secrets/secrets.yaml";
    # secrets."claude/base_url".owner = "erkik";
    secrets.claude_token = {
      sopsFile = "./nix-darwin/secrets/claude.yaml";
